...
def main():
    ...
    for method in ('vine', 'hierarchical', 'repid', 'cohex'):
        print(f'======== {method} ========')
        bike_locality(method, explainer_type='lime')
        bike_stability_cohort(method, explainer_type='lime')
        bike_stability_importance(method, explainer_type='lime')
        bike_num_cohorts(method, explainer_type='lime')
